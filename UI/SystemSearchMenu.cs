...
namespace UI
{
    ...
    private void FilterSystems()
    {
        bool loop = true;
            ...
            Console.WriteLine("[3] to filter by maximum system price");
            Console.WriteLine("[4] to filter by release date");
            string choice = Console.ReadLine();
            Console.WriteLine("--------------------");
            switch (choice)
            {
                ...
                case "1":
                    loop=false;
                    readout=_systemBL.FilterSystems(filter);
                ...
                case "3":
                    ...
                    filter.sMSRP=float.Parse(Console.ReadLine());
                    break;
                case "4":
